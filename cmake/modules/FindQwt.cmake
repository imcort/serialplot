...
if (QWT_LIBRARY AND (NOT qwt_is_static))
  # Homebrew may provide Qwt as a framework on macOS.
  if (APPLE AND QWT_LIBRARY MATCHES "\\.framework")
    ...
    foreach (dep ${qwt_lib_deps})
      if (${dep} MATCHES "libQt6Gui" OR ${dep} MATCHES "QtGui\\.framework")
        set(qwt_is_qt6 TRUE)
      endif()
    endforeach ()
    if (NOT qwt_is_qt6)
      message(WARNING "Found qwt library (${QWT_LIBRARY}) isn't compiled with Qt6!")
